...
public class ArrayOperations {
    public static void main(String[] args) {
        ...
        printArray(array); // print the initial array
        setLargestValue(array); // set the largest value as the value for each element in the array
        printArray(array); // print the modified array
        System.out.println();
        input.close();
    }
    ...
    // method to find the largest value in the array and set it as the value for each element
