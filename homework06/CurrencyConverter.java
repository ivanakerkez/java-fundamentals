...
public class CurrencyConverter {
    ...
    // this method converts the given amount from RSD (Serbian Dinar) to the specified currency.

    public static double convertCurrency(double amount, String currency) {
        switch (currency) {
            case "EUR":
                return amount / 117.64; // Conversion rate from RSD to EUR
            case "USD":
                return amount / 106.51; // Conversion rate from RSD to USD
            case "GBP":
                return amount / 134.26; // Conversion rate from RSD to GBP
            default:
